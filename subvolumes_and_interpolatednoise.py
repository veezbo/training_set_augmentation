...
def getSampleVolumes(image_stack, target_stack, input_padding, data_patchsize, label_patchsize, num_samples):
    ...
    for i in range(num_samples):
        ...
        while True:
            ...
            if arePointsInside(data_dim, getFourCorners(data_offset[2:], data_patchsize[2:]), angle) and arePointsInside(label_dim, getFourCorners(label_offset[2:], label_patchsize[2:]), angle):
